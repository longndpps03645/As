...
<title>Shop Thời Trang Nữ : Chuyên Quần Áo Thời Trang , Phụ Kiện Dành Cho Teen Girl</title>
...
<table width="990" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td>
	<img src="http://shopbi.net/Ver-1.0/images/top.jpg" width="989" height="290"  /></td>
  </tr>
  <tr>
      ...
      <tr>
        <td width="28%" height="31" align="center" valign="middle" background="images/lang.jpg" ><table width="90%" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            ...
            <td width="59%" style="padding-right:20px;">
				<a href="http://translate.google.com.vn/translate?hl=vi&sl=vi&tl=en&u=http%3A//shopbi.net/shop" target="_blank" class="link_lang">
				<img src="images/en.jpg" width="26" height="17" border="0" align="absmiddle" />&nbsp;&nbsp;Tiếng Anh</a></td>
          </tr>
        </table></td>
  ...
  <tr>
    <td id="left" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="24%" valign="top" id="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="margin_bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="2" class="border_left_right"><table width="100%" border="0" cellspacing="3" cellpadding="0">
                  <tr>
                    <td height="25" align="center" valign="bottom"><strong><?=$_lang=='vn' ? 'HotLine : 0906043200':'Direct purchase'?></strong></td>
                  </tr>
                  <tr>
              ...
              <tr>
                <td align="left" valign="bottom" class="border_bottom" width="51%"><img src="images/cover_3.jpg" width="4" height="4" /></td>
                <td align="right" valign="bottom" class="border_bottom" width="4"><img src="images/cover_4.jpg" width="4" height="4" /></td>
              </tr>
            </table></td>
          </tr>
		  <tr>
        ...
        <td width="43%" valign="top" id="center"><table width="100%" border="0" cellspacing="6" cellpadding="0">
          <tr>
            <td align="center">
				<? include('box/box_banner.php')?>
			</td>
          </tr>
          <tr>
        ...
        <td width="33%" valign="top" id="right"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="margin_bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="top" class="border_top"><img src="images/cover_1.jpg" width="4" height="4" /></td>
  ...
  <tr>
    <td id="bottom"><? include('module/contactInfoDetailShort.php')?><span class="name">
    © Copyright 2011 by VietNext&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	Developed by
	<a href="http://www.shopbi.net">ChenZi</a></span></td>
  </tr>
</table>
