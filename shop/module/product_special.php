...
<table align="center" cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<tr>
		<td align="center">
			<font color="#333333"><b><?=$_lang=="vn"?'Sản phẩm đang cập nhật !':'Products are being updated !'?></b></font>
		</td>
	</tr>
	<tr><td height="10"></td></tr>
</table>
...
<IMG 
src="<?=$pro['image']; ?>" width="165" height="114" border=0 onmouseover="showtrail('<? if ($pro['image_large']!='') echo $pro['image_large']; else echo $pro['image']; ?>','',<?=$width; ?>,<?=$height;?>)" onmouseout=hidetrail()></A>
